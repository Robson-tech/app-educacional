...
class Ui_AtividadeProfessor(object):
    def setupUi(self, AtividadeProfessor, materia_id=None, turma_id=None):
...
#         self.input_enunciado[self.num_questoes] = QtWidgets.QLineEdit(self.questoes[f'questao_{self.num_questoes}'])
...
#         self.input_A[self.num_questoes] = QtWidgets.QLineEdit(self.questoes[f'questao_{self.num_questoes}'])
...
#         self.input_B[self.num_questoes] = QtWidgets.QLineEdit(self.questoes[f'questao_{self.num_questoes}'])
...
#         self.input_C[self.num_questoes] = QtWidgets.QLineEdit(self.questoes[f'questao_{self.num_questoes}'])
...
#         self.input_D[self.num_questoes] = QtWidgets.QLineEdit(self.questoes[f'questao_{self.num_questoes}'])
...
#         self.input_E[self.num_questoes] = QtWidgets.QLineEdit(self.questoes[f'questao_{self.num_questoes}'])
