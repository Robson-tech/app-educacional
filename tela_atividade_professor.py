...
class Ui_Atividade(object):
    def setupUi(self, Atividade):
        ...
        self.input_materia.setStyleSheet("background-color: rgb(255, 255, 255);")
...
"background-color: rgb(252, 88, 20);")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(21, 530, 861, 47))
...
"background-color: rgb(0, 166, 202);")
    ...
    def retranslateUi(self, Atividade):
        ...
        self.input_materia.setPlaceholderText(_translate("Atividade", "Matéria"))
